class Import < ApplicationRecord
  ...
  TYPES = %w[TransactionImport TradeImport AccountImport MintImport CategoryImport RuleImport PdfImport StatementImport QifImport SureImport].freeze
  SIGNAGE_CONVENTIONS = %w[inflows_positive inflows_negative]
  SEPARATORS = [ [ "Comma (,)", "," ], [ "Semicolon (;)", ";" ] ].freeze

  NUMBER_FORMATS = {
    "1,1023.00" => { separator: ".", delimiter: "," },  # US/UK/Asia
  ...
  private
    ...
    def set_default_number_format
      self.number_format ||= "1,1023.00" # Default to US/UK format
    end
