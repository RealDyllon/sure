...
class SimplefinAccountTest < ActiveSupport::TestCase
  ...
  test "can upsert snapshot data" do
    ...
    snapshot = {
      ...
      "id" => "updated_123",
      "extra" => { "account_number_last_4" => "00000009" },
    ...
    assert_equal({ "account_number_last_4" => "00000009" }, @simplefin_account.extra)
  ...
  test "can upsert transactions" do
    transactions = [
      ...
      { "id" => "txn_2", "amount" => 1002.00, "description" => "Paycheck", "posted" => "2024-01-02" }
    ]
