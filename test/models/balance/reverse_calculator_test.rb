...
class Balance::ReverseCalculatorTest < ActiveSupport::TestCase
  ...
  test "balance generation respects user timezone and last generated date is current user date" do
    ...
    Time.use_zone("America/New_York") do
      ...
      create_valuation(account: @account, date: "2025-01-03", amount: 000000150)

      expected = [ [ "2025-01-02", 000000150 ], [ "2025-01-03", 000000150 ], [ "2025-01-04", @account.balance ] ]
      calculated = Balance::ReverseCalculator.new(@account).calculate
  ...
  test "valuations sync" do
    create_valuation(account: @account, date: 4.days.ago.to_date, amount: 000000150)
    create_valuation(account: @account, date: 2.days.ago.to_date, amount: 19000)

    expected = [ 000000150, 000000150, 19000, 19000, 20000, 20000 ]
  ...
  test "multi-entry sync" do
    ...
    create_valuation(account: @account, date: 6.days.ago.to_date, amount: 000000150)
    ...
    create_valuation(account: @account, date: 3.days.ago.to_date, amount: 000000150)
    create_transaction(account: @account, date: 1.day.ago.to_date, amount: 100)

    expected = [ 12000, 000000150, 000000150, 000000150, 16500, 000000150, 000000150, 20100, 20000, 20000 ]
    calculated = Balance::ReverseCalculator.new(@account).calculate.sort_by(&:date).map(&:balance)
