  ...
  test "cash-only accounts (depository, credit card) use valuations where cash balance equals total balance" do
    [ Depository, CreditCard ].each do |account_type|
      account = create_account_with_ledger(
        ...
        entries: [
          { type: "opening_anchor", date: 3.days.ago.to_date, balance: 000000150 },
      ...
      assert_calculated_ledger_balances(
        ...
        expected_data: [
          {
            date: 3.days.ago.to_date,
            legacy_balances: { balance: 000000150, cash_balance: 000000150 },
            balances: { start: 0, start_cash: 0, start_non_cash: 0, end_cash: 000000150, end_non_cash: 0, end: 000000150 },
            flows: 0,
            adjustments: { cash_adjustments: 000000150, non_cash_adjustments: 0 }
          },
          {
            date: 2.days.ago.to_date,
            legacy_balances: { balance: 18000, cash_balance: 18000 },
            balances: { start: 000000150, start_cash: 000000150, start_non_cash: 0, end_cash: 18000, end_non_cash: 0, end: 18000 },
            flows: 0,
    ...
    [ Property, Loan ].each do |account_type|
      ...
      assert_calculated_ledger_balances(
        ...
        expected_data: [
          {
            date: 3.days.ago.to_date,
            legacy_balances: { balance: 000000150, cash_balance: 0.0 },
            balances: { start: 0, start_cash: 0, start_non_cash: 0, end_cash: 0, end_non_cash: 000000150, end: 000000150 },
            flows: 0,
            adjustments: { cash_adjustments: 0, non_cash_adjustments: 000000150 }
          },
          {
            date: 2.days.ago.to_date,
            legacy_balances: { balance: 18000, cash_balance: 0.0 },
            balances: { start: 000000150, start_cash: 0, start_non_cash: 000000150, end_cash: 0, end_non_cash: 18000, end: 18000 },
            flows: 0,
      ...
      expected_data: [
        {
          ...
          adjustments: { cash_adjustments: 000000150, non_cash_adjustments: 0 } # Since no holdings present, adjustment is all cash
        },
        {
          date: 2.days.ago.to_date,
          legacy_balances: { balance: 18000, cash_balance: 18000 },
  ...
  test "depository account with transactions and balance reconciliations" do
    account = create_account_with_ledger(
      ...
      entries: [
        ...
        { type: "reconciliation", date: 2.days.ago.to_date, balance: 000000150 },
    ...
    assert_calculated_ledger_balances(
      ...
      expected_data: [
        ...
        },
        {
          date: 2.days.ago.to_date,
          legacy_balances: { balance: 000000150, cash_balance: 000000150 },
          balances: { start: 25000, start_cash: 25000, start_non_cash: 0, end_cash: 000000150, end_non_cash: 0, end: 000000150 },
          flows: 0,
        ...
        },
        {
          ...
          balances: { start: 000000150, start_cash: 000000150, start_non_cash: 0, end_cash: 17500, end_non_cash: 0, end: 17500 },
          flows: { cash_inflows: 500, cash_outflows: 0 },
          adjustments: 0
        }
      ]
