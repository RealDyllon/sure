...
class Provider::IndexaCapitalTest < ActiveSupport::TestCase
  ...
  test "raises ConfigurationError with partial credentials" do
    ...
    assert_raises Provider::IndexaCapital::ConfigurationError do
      Provider::IndexaCapital.new(username: "user@example.com", document: "0000000900000018A")
    end
  end
  ...
  test "list_accounts calls API and returns accounts" do
    ...
    stub_response = OpenStruct.new(
      ...
      body: {
        accounts: [
          { account_number: "ABC000000095", type: "mutual", status: "active" },
    ...
    assert_equal "ABC000000095", accounts[0][:account_number]
    assert_equal "Indexa Capital Mutual Fund (ABC000000095)", accounts[0][:name]
  ...
  test "get_holdings calls fiscal-results endpoint" do
    ...
    data = provider.get_holdings(account_number: "ABC000000095")
  ...
  test "get_account_balance extracts total_amount from portfolios" do
    ...
    balance = provider.get_account_balance(account_number: "ABC000000095")
  ...
  test "get_activities returns empty array" do
    provider = Provider::IndexaCapital.new(api_token: "test_token")
    result = provider.get_activities(account_number: "ABC000000095")
    assert_equal [], result
  end
