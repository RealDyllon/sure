# Financial Goals Specification

## Purpose
Provide family-level goal planning surfaces that help users track progress toward Singapore-aware financial independence, emergency funding, debt payoff, savings rate, and custom financial targets using existing app data and configurable assumptions.
